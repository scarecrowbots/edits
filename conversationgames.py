    ...
    def __init__(self):
        ...
        default_global = {
            ...
            "truths": [
                ...
                "If you were to have a threesome in the server, who would it be with and why?",
                "Who do you want to sleep with the most, out of everyone here?",
                "What's the first thing you would do if you woke up one day as the opposite sex?",
                "What's your favourite fantasy to pleasure yourself to?",
                "Do you have a I'm getting laid tonight outfit If so, what is it",
                "Who here are you most jealous of?",
                "Of the people here, who do you want to trade lives with?",
                "Have you ever had an exciting dream about anybody here? If so, who?",
                ...
                "Who would you take a shower with out of everyone here?",
            ...
            "dares": [
                ...
                "Make a secret message for somebody in the server. If they get it right, you have to do something of their choosing. If they guess wrong, they've got to do something of your choosing.",
                ...
                "Send me a pic of your best nude, if you have none make one just for me.",
                "Be my one day boyfriend or girlfriend.",
                "Write your and my name in your status for 1 day.",
                "Do whatever the darer tells you for a few minutes.",
                "Play a game of reward or punishment. The darer gets to ask you three questions relating to your knowledge of them. If you get them right, you get a reward, if you get them wrong, you get a punishment.",
                "Select one mobile number blindfolded from your contacts and send one breakup message to him/her. Screenshot the response.",
                "Pretend you are auctioning your favourite toy. Describe what you like about it.",
                "Give your parts a name and do a stream of consciousness for it.",
                ...
                "Make a video call to me and perform a striptease.",
                "Open your gallery, close your eyes, scroll randomly and select one picture and send it to me.",
                "Send the dirtiest message in emojis that the darer has to decode.",
                "Put any picture i decide as your mobile wallpaper for three days.",
                "Send a selfie of yours while keeping your finger in your nose.",
                "The darer gets to choose your PFP for a day",
                "Send your sexiest selfie.",
                "Make a dirty video, of your best attempt to make the darer cum.",
                "Send next five text messages to your friends using your elbow only.",
                "The Darer picks your outfits for the next two days, anything goes.",
                "Send every photo on your phone to your crush.",
